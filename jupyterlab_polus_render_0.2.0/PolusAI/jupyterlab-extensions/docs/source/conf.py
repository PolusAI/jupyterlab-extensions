...
# -*- coding: utf-8 -*-
#
# jupyterlab-polus-render documentation build configuration file
#
...
project = 'jupyterlab-polus-render'
copyright = '2024, Jeff Chen, Akshat Saini'
author = 'Jeff Chen, Akshat Saini'
...
_version_py = os.path.join(repo, 'jupyterlab-polus-render', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyterlab-polus-renderdoc'
...
latex_documents = [
    (master_doc, 'jupyterlab-polus-render.tex', 'jupyterlab-polus-render Documentation',
     'Jeff Chen, Akshat Saini', 'manual'),
]
...
man_pages = [
    ...
    'jupyterlab-polus-render Documentation',
     [author], 1)
]
