...
import {IGenericCollection} from '../sidebar'
 ...
 */
interface IGenericTableHeaderComponentProps<T> {
    headers: [keyof T, string][];
...
*/
function TableHeaderComponent<T> (props: IGenericTableHeaderComponentProps<T>) {
   ...
   */
  function TableRowComponent(props: IGenericTableRowComponentProps<IGenericCollection>) {
