...
# -*- coding: utf-8 -*-
#
# jupyterlab_polus_render documentation build configuration file
#
...
project = 'jupyterlab_polus_render'
copyright = '2024, Akshat Saini, Jeff Chen'
author = 'Akshat Saini, Jeff Chen'
...
_version_py = os.path.join(repo, 'jupyterlab_polus_render', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyterlab_polus_renderdoc'
...
latex_documents = [
    (master_doc, 'jupyterlab_polus_render.tex', 'jupyterlab_polus_render Documentation',
     'Akshat Saini, Jeff Chen', 'manual'),
]
...
man_pages = [
    ...
    'jupyterlab_polus_render Documentation',
     [author], 1)
]
