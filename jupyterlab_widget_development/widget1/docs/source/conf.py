...
# -*- coding: utf-8 -*-
#
# widget1 documentation build configuration file
#
...
_version_py = os.path.join(repo, 'widget1', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'widget1.tex', 'widget1 Documentation',
     'akshat saini', 'manual'),
]
