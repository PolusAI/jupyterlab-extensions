...
# -*- coding: utf-8 -*-
#
# widget4 documentation build configuration file
#
...
_version_py = os.path.join(repo, 'widget4', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'widget4.tex', 'widget4 Documentation',
     'as', 'manual'),
]
