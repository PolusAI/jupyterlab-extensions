...
# -*- coding: utf-8 -*-
#
# widget3 documentation build configuration file
#
...
_version_py = os.path.join(repo, 'widget3', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'widget3.tex', 'widget3 Documentation',
     'as', 'manual'),
]
